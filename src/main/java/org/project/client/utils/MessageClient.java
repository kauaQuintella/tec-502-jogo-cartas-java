...
public class MessageClient {
    ...
    public MessageClient(String infoMessage, String sender, Content content) {
        this.infoMessage = "";
        this.sender = sender;
    ...
    public void sendMessage(String command, PrintWriter out){
    ...
    public MessageClient reciveMessage(BufferedReader in) throws IOException {
        timestamp = System.currentTimeMillis();

        String answerJson = in.readLine();
        return GsonSingleton.INSTANCE.getGson().fromJson(answerJson, MessageClient.class);
